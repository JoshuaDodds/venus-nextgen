...
export const ListViewWithTotals: React.FunctionComponent<ListViewWithTotalsProps> =
  ({ child, icon, title, totals, subTitle, children }) => (
    <div className={classnames({ metric: !child }, "list-view")}>
      <div className="list-view__header">
        ...
        <div className="metric__value-container">
          ...
          {subTitle && (
            <span className="text--very-small text--opaque text--subtitle-upper">
              {subTitle}
            </span>
          )}
...
export const ListRow: React.FunctionComponent<any> = ({ children }) => (
