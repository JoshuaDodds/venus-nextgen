...
export const Header = (props: HeaderProps) => {
  ...
  return (
    <Fragment>
      <header>
        <img
          onClick={() => modalVersionInfoRef.current.open()}
          src={Logo}
          className="logo"
          alt={"Logo"}
        />
        ...
        <div className="header-button-container">
          ...
          {showRemoteConsoleSetting && (
            <button
              className="remote-console-button"
  ...
  return (
    <div className="header__paginator">
      ...
      >
        <img
          src={LIcon}
          className="header__paginator-button"
          alt={"Header Paginator Button"}
        />
      </SelectorButton>
          ...
          Array.from(Array(pages).keys()).map((page) => (
            <svg height="50" width="20" key={page}>
              <circle
                ...
                cy="25"
                r="5"
                fill={page === currentPage ? "#30afff" : "#aaa"}
              />
            </svg>
          ))}
      </span>
